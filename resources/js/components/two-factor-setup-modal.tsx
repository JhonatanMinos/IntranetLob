      ...
      {errors?.length ? (
        ...
        <>
          ...
          <div className="relative flex w-full items-center justify-center">
            ...
            <span className="relative bg-card px-2 py-1">o, ingresa el código manualmente</span>
          </div>
  ...
  const modalConfig = useMemo<{
    ...
    if (twoFactorEnabled) {
      return {
        ...
        description:
          'La autenticación de dos factores ahora está habilitada. Escanea el código QR o ingresa la clave de configuración en tu aplicación autenticadora.',
        buttonText: 'Cerrar',
      };
    }
    ...
    return {
      ...
      description:
        'Para finalizar la configuración, escanea el código QR o ingresa la clave en tu aplicación autenticadora',
      buttonText: 'Continuar',
    };
