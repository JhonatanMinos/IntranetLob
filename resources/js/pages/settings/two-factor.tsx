          ...
          {twoFactorEnabled ? (
            <div className="flex flex-col items-start justify-start space-y-4">
              ...
              <p className="text-muted-foreground">
                Con la autenticación de dos factores habilitada, se te pedirá un PIN aleatorio seguro
                durante el inicio de sesión, que podrás obtener desde la aplicación TOTP compatible
                en tu teléfono.
              </p>
            ...
            <div className="flex flex-col items-start justify-start space-y-4">
              ...
              <p className="text-muted-foreground">
                Cuando habilites la autenticación de dos factores, se te pedirá un PIN seguro durante
